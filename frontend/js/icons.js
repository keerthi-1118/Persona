/**
 * icons.js — SVG Line-Art icon library for Persona
 * Injects a global SVG <defs> sprite sheet into the body.
 */
(function() {
  'use strict';
  ...
  const iconShapes = {
    ...
    'ribbon': '<circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline>',
    ...
    'trash': '<polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="12" y1="11" x2="12" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line><line x1="10" y1="11" x2="10" y2="17"></line>',
  ...
  function injectSpriteSheet() {
    if (document.getElementById('persona-icon-sprites')) return;

    const svgNS = "http://www.w3.org/2000/svg";
    const svg = document.createElementNS(svgNS, "svg");
    svg.id = "persona-icon-sprites";
    svg.style.display = "none";

    let defsHtml = '<defs>';
    for (const [id, pathData] of Object.entries(iconShapes)) {
      defsHtml += `
        <symbol id="icon-${id}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
          ${pathData}
        </symbol>
      `;
    }
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', injectSpriteSheet);
  } else {
    injectSpriteSheet();
  }
})();
